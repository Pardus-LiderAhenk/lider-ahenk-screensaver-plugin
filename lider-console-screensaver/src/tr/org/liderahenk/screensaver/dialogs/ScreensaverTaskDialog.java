...
/**
 * Task execution dialog for screensaver plugin.
 * 
 */
public class ScreensaverTaskDialog extends DefaultTaskDialog {
	
	private static final Logger logger = LoggerFactory.getLogger(ScreensaverTaskDialog.class);
	
	// TODO do not forget to change this constructor if SingleSelectionHandler is used!
	public ScreensaverTaskDialog(Shell parentShell, Set<String> dnSet) {
